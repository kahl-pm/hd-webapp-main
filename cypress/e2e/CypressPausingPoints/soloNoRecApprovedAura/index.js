...
describe('Solo No Recommendation to Aura', {
  ...
  it('Goes through start app to the beginning of Aura', () => {
    ...
    // Use the current approved Aura Pathway here, or continue with Cypress Studio on soloNoRec.
    ...
    cy.SingleChoiceRadio('What is your status in Canada?', 'Permanent resident or applied for permanent residency');
    cy.AvailableUnit('What is your height?', 'centimeters', [180]);
    cy.AvailableUnit('What is your weight?', 'pounds', [160]);
