...
import { BMOI_HD_PLAN_TYPES } from '@policyme/global-libjs-utils';
import { UNDERWRITING_METHODS, PM_PRODUCT_TYPE, COVERAGE_FIT_OPTIONS } from '../../../../src/utils/const';
...
export const testCaseData: TestInput = {
  ...
  primary: {
    ...
    hdTriage: {
      ...
      hdPlanType: BMOI_HD_PLAN_TYPES.STANDARD,
      hdPrescriptionDrugs: 'Y',
      groupBenefits: 'N',
      existingHdCov: 'N',
      coverageFitFlag: COVERAGE_FIT_OPTIONS.PRESCRIPTION_DENTAL_COVERAGE_NEEDED,
    },
    ...
    desiredCoverageAmountSliderValue: 225000,
    jointPolicy: {
      policy: 'Just Me',
      partnerBirthdate: '',
      partnerGender: '',
