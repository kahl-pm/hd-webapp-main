...
import { getCurrentUser, isDigitalConsentJourney } from '../../Selectors/userControl';
import { LEGACY_SEGMENT_EVENTS, PM_PRODUCT_PREFIX, ROUTES, SEGMENT_EVENTS, STRIPE_WALLETS, UserType } from '../../utils/const';
...
export default AGPPaymentFrame;
